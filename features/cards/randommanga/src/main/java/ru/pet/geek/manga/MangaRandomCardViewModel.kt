package ru.pet.geek.manga

import ru.pet.geek.basecards.BaseRandomCardViewModel
import ru.pet.geek.basecards.SuccessUiState
...
constructor(
        ...
        SuccessUiState(
            mainInfo =
                MainInfoWidgetDataUiImpl(
                    ...
                    title = titles.toUi(),
                    onImageClick = {
                        onMainInfoImageClick(contentId = this.malId, imageModel = images)
                    }
                ),
    ...
    private fun onMainInfoImageClick(contentId: Int, imageModel: ImagesModel) {
        val largeImage = imageModel.jpg.largeImageUrl
        navApi.navigateToImageRemoteScreen(contentId = contentId, imageUrl = largeImage)
    }
